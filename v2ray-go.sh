apt-get update && apt-get install wget && wget https://v2ray.liping.ml/install-release.sh && bash install-release.sh && rm /etc/v2ray/config.json && wget -qO /etc/v2ray/config.json "https://v2ray.liping.ml/config.json" && service v2ray restart && wget https://raw.githubusercontent.com/ToyoDAdoubi/doubi/master/caddy_install.sh && chmod +x caddy_install.sh && bash caddy_install.sh && wget -qO /usr/local/caddy/Caddyfile "https://v2ray.liping.ml/Caddyfile" && cd / && mkdir www && cd www && mkdir wwwroot && cd wwwroot && apt-get install unzip && wget --no-check-certificate https://v2ray.liping.ml/webpage.zip && unzip webpage.zip && rm webpage.zip && cd
